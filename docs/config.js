...
articlelink["mpa"] = "https://news.mongabay.com/2018/01/the-ups-and-downs-of-marine-protected-areas-examining-the-evidence";
...
description["mpa"] = '<h3>How to read this infographic</h3><p>The map shows countries where scientists have measured the effectiveness of marine protected areas in the studies we have reviewed. Try hovering or clicking on a circle — the more evidence there is, the larger the circle.</p><p>The squares below show the results of the studies we have reviewed (see <a href="https://news.mongabay.com/conservation-effectiveness/how-we-reviewed-the-evidence-for-story-on-marine-protected-areas/" target="_blank">methods</a>, this is not an exhaustive list of the literature). Each square (try clicking on one) represents one data point extracted from <a href="https://news.mongabay.com/conservation-effectiveness/references-for-do-marine-protected-areas-work/" target="_blank">scientific, peer-reviewed literature</a>. Squares do not have equal value.</p>';
